...
const HIGHLIGHTS = ["24/7 emergency cover", "NICEIC approved", "Fixed transparent pricing"];
...
export default function ContactHero() {
  ...
  return (
    <section
      className="home1-contact-hero relative bg-black overflow-x-clip pb-10 sm:pb-12 lg:pb-14"
    ...
    >
      ...
      <div className={`${SERVICES_PAGE_CONTAINER} relative z-10`}>
        ...
        >
          ...
          >
            Get in touch with{" "}
            <span className="text-[#ff5a3c]">Urgent Electrical</span>
          </motion.h1>
          ...
          >
            Call, email, or send a message — NICEIC approved electricians serving Nottingham and the East Midlands.
          </motion.p>
